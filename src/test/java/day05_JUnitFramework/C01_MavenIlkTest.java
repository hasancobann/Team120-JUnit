...
public class C01_MavenIlkTest {
    public static void main(String[] args) throws InterruptedException {
        ...
        /*
        bir üst satırı yazmamız mecburi değildir.
        Selenium 4.8 versiyonunda itibaren kendi webdriver'ını oluşturmuştur.
        Biz 13. satırdaki gibi dışardan bir webdriver tanımlamazsak
        Selenium otomatik olarak kendi WebDriver'ını devreye sokar.
         */
